	...
	$.fn.modal_box = function(prop){
		 ...
		 */
		 ...
		 function add_popup_box(){
			 var pop_up = $('<div class="modal_box"><a href="#" class="modal_close"></a><div class="inner_modal_box"><h2>' + options.title + '</h2><p><center><img src= ' + options.image + ' style="float:left,width:200px;height:150px"><br></p><P STYLE="font-size: 17pt; text-align: left;">' + options.description + '</p></div></div>');
