...
<meta charset="UTF-8">
<title>Be Well</title>
<link rel="stylesheet" type="text/css" href="<?=base_url();?>/assets/css/cardRead.css" media="screen"  />
...
<body>
    <div id="content-wrapper">	
		...
		<section>
			 <h2 id="info" >Before you can continue, agree the terms of use</h2>
			 <br>
				 <div id="buttons">
			...
			<br> <a href="<?=base_url();?>index.php/beWell/cardLoad" id="next" class="butn" type="submit"></a>
		</section>
