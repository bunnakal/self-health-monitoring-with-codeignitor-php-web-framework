<?php
$lang['title'] = "Terms of use Card Reader";

$lang['help_text_regel1'] = "You have to agree with the terms of use in order to continue.";
$lang['help_text_regel2'] = "";
$lang['help_text_regel3'] = "";
$lang['help_title'] = "Help with the reading the eID";
...
An electronic ID card is valid for five years from the date of issue. As the Certificate Authority the Population Register Centre individualises the certificate by means of the holders electronic client
identifier, which is also an element of the certificates information content.<br> <b>USING AN ELECTRONIC ID CARD A PIN</b><br> (Personal Identification Number) must be entered in order to use an ID card. There are two
...
impaired hearing is available free of charge at http://www.tekstipuhelu.fi. <br><b>CHANGING THE PIN CODE</b><br>
